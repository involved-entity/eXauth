...
const (
	...
	Auth_RegenerateCode_FullMethodName       = "/auth.Auth/RegenerateCode"
	Auth_ActivateAccount_FullMethodName      = "/auth.Auth/ActivateAccount"
	Auth_ResetPassword_FullMethodName        = "/auth.Auth/ResetPassword"
	Auth_ResetPasswordConfirm_FullMethodName = "/auth.Auth/ResetPasswordConfirm"
)
...
type AuthClient interface {
	...
	RegenerateCode(ctx context.Context, in *RegenerateCodeRequest, opts ...grpc.CallOption) (*RegenerateCodeResponse, error)
...
func (c *authClient) RegenerateCode(ctx context.Context, in *RegenerateCodeRequest, opts ...grpc.CallOption) (*RegenerateCodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegenerateCodeResponse)
	err := c.cc.Invoke(ctx, Auth_RegenerateCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ResetPasswordConfirm(ctx context.Context, in *ResetPasswordConfirmRequest, opts ...grpc.CallOption) (*ResetPasswordConfirmResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_ResetPasswordConfirm_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	RegenerateCode(context.Context, *RegenerateCodeRequest) (*RegenerateCodeResponse, error)
...
func (UnimplementedAuthServer) RegenerateCode(context.Context, *RegenerateCodeRequest) (*RegenerateCodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegenerateCode not implemented")
}
...
func (UnimplementedAuthServer) ResetPasswordConfirm(context.Context, *ResetPasswordConfirmRequest) (*ResetPasswordConfirmResponse, error) {
...
func _Auth_RegenerateCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegenerateCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).RegenerateCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_RegenerateCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RegenerateCode(ctx, req.(*RegenerateCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Auth_ResetPasswordConfirm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_ResetPasswordConfirm_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegenerateCode",
			Handler:    _Auth_RegenerateCode_Handler,
		},
		{
